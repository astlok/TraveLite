...
//    func travelCreate(with trek: TrekCreateRequest, completion: @escaping (Result<TrekCreateResponse, Error>) -> Void) {
...
//                userProfile.nickname = trek.nickname
//                userProfile.email = trek.email
//                userProfile.nickname = trek.nickname
